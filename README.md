...
It has needing to acess the page: http://localhost:8080 to MySQL DataBase or http://localhost:8081 to Oracle DataBase.
...
Downloads: It does download of the MySQL or Oracle Data Base 21c (In file application.properties: It must the DataBase: MySQL  or Oracle), and of the Eclipse 2021.
